...
- **Files**: `FrozenBuildManifest.cs`, engine-side mapping resolver, `BuildManifestStore.cs` (`builds/manifests/{hash}.json`), `ProcAttributionEnricher.cs`.
